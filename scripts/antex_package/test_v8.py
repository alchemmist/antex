...
from antex_package.targets import TARGET_SPECS, TargetSpec


class FetchAntexV8ArtifactsTest(unittest.TestCase):
    version = "150.4.0"
    ...
    def test_fetches_artifacts_after_authenticating_manifest(self) -> None:
        with self.release("x86_64-unknown-linux-gnu") as (
            ...
            artifacts = v8.fetch_antex_v8_artifacts(
