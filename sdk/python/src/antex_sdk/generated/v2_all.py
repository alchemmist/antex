...
#   filename:  antex_app_server_protocol.v2.schemas.json
...
class ChatgptAuthTokensLoginAccountParams(BaseModel):
    ...
    chatgpt_plan_type: Annotated[
        ...
        Field(
            ...
            description="Optional plan type supplied by the client.\n\nWhen `null`, Antex attempts to derive the plan type from access-token claims. If unavailable, the plan defaults to `unknown`.",
        ),
    ] = None
    type: Annotated[
...
class SubagentSpawnPolicy(Enum):
    disallow = "disallow"
    allow = "allow"
...
class ThreadApproveGuardianDeniedActionParams(BaseModel):
    ...
    event: Annotated[
        Any, Field(description="Serialized `antex_protocol::protocol::GuardianAssessmentEvent`.")
    ]
    thread_id: Annotated[str, Field(alias="threadId")]
...
class WebSearchThreadItem(BaseModel):
    ...
    results: Annotated[
        list | None,
        Field(
            description="Structured search results returned out-of-band by standalone web search.\n\nThese stay as opaque JSON at the extension/app-server boundary so new result fields and result types can pass through without a Antex release."
        ),
    ] = None
...
class Turn(BaseModel):
    ...
    id: Annotated[
        str, Field(description="Identifier for this turn. Antex-generated turn IDs are UUIDv7.")
    ]
    items: Annotated[
...
class Thread(BaseModel):
    ...
    id: Annotated[
        str, Field(description="Identifier for this thread. Antex-generated thread IDs are UUIDv7.")
    ]
    model: Annotated[
        str | None,
        Field(
    ...
    source: Annotated[
        SessionSource,
        Field(
            description="Origin of the thread (CLI, VSCode, antex exec, antex app-server, etc.)."
        ),
    ]
