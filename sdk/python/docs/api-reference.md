...
Antex prepares instructions from the model catalog, such as when starting a
...
on resume/fork require Antex CLI 0.151.0 or newer. The SDK raises `CodexError`
...
using `AntexConfig.antex_bin`, choose a compatible executable. Unversioned local
