...
use antex_guardian_context::TranscriptImageInput;
use antex_guardian_context::TranscriptRetentionConfig;
use antex_guardian_context::TrustedTool;
...
pub(crate) struct ContextInput<'a> {
    ...
    pub(crate) node_repl_images: Option<&'a [antex_protocol::models::ContentItem]>,
}
