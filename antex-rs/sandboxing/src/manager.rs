...
impl SandboxManager {
    ...
    pub fn transform(
        ...
        let (argv, arg0_override, pending_sandboxed_request) = match sandbox {
            ...
            SandboxType::WindowsMxc => {
                ...
                if !antex_mxc_sandbox::is_available() {
                    return Err(SandboxTransformError::WindowsMxcPreparation(
                ...
                full_command.extend(
                    antex_mxc_sandbox::create_command_args(
                        antex_mxc_sandbox::CreateMxcCommandArgsParams {
                            command: argv,
    ...
    pub fn transform_for_direct_spawn(
        ...
        if request.transform.sandbox == SandboxType::WindowsRestrictedToken {
            ...
            return self.transform_for_direct_spawn_with_antex_home(request, codex_home.as_path());
        }
