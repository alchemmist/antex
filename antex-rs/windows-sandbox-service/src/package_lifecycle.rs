...
use antex_windows_sandbox::PreparedWindowsSandboxCleanup;
use antex_windows_sandbox::clean_up_packaged_windows_sandbox;
use antex_windows_sandbox::create_directory_guard;
use antex_windows_sandbox::prepare_packaged_windows_sandbox_cleanup;
...
impl PackageLifecycle {
    ...
    pub(crate) fn clean_up(&self) -> Result<()> {
        let _setup_lock =
            antex_windows_sandbox::acquire_sandbox_setup_lock(/*timeout_ms*/ 5_000)?;
