...
pub(crate) use antex_windows_sandbox::CORE_INSTALLATION_KEY;
pub(crate) use antex_windows_sandbox::DesktopInstallation;
pub(crate) use antex_windows_sandbox::INSTALLATION_KEY;
pub(crate) use antex_windows_sandbox::INSTALLATION_VALUE;
pub(crate) use antex_windows_sandbox::InstallationRecord;
pub(crate) use antex_windows_sandbox::RuntimeAccountRegistration;
pub(crate) use antex_windows_sandbox::RuntimeRegistration;
pub(crate) use antex_windows_sandbox::load_installation as load;
pub(crate) use antex_windows_sandbox::remove_installation as remove;
pub(crate) use antex_windows_sandbox::save_installation as save_runtime;
...
pub(crate) fn save(mut record: InstallationRecord) -> Result<InstallationRecord> {
    let _setup_lock = antex_windows_sandbox::acquire_sandbox_setup_lock(/*timeout_ms*/ 5_000)?;
