...
This crate routes a command through the current Antex executable and directly
...
elevation. The existing Antex Windows sandboxes remain separate backends.
...
from the canonical Antex permission profile, including protected metadata
...
executor's Antex executable as the native SDK helper. It carries one typed
