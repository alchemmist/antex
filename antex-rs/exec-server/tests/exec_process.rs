...
async fn assert_remote_windows_sandbox_process_write(
    expected_sandbox_type: antex_sandboxing::SandboxType,
    tty: bool,
) -> Result<()> {
    if expected_sandbox_type == antex_sandboxing::SandboxType::WindowsMxc {
