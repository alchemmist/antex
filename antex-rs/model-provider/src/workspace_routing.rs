...
use antex_login::WorkspaceRoutingSession;
...
pub(crate) fn apply_workspace_routing(
    provider: &mut antex_api::Provider,
...
pub struct ResolvedResponsesProvider {
    pub provider: antex_api::Provider,
...
impl ResponsesConnectionKey {
    pub fn new(provider: &antex_api::Provider, auth_revision: Option<u64>) -> Self {
        Self {
