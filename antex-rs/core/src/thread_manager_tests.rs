...
impl antex_extension_api::UserInstructionsProvider for ParentInstructionsProvider {
    fn load_user_instructions(&self) -> antex_extension_api::LoadInstructionsFuture<'_> {
        Box::pin(async move {
...
impl antex_extension_api::ThreadInstructionsProvider for ParentInstructionsProvider {
    fn load_thread_instructions(&self) -> antex_extension_api::LoadInstructionsFuture<'_> {
        antex_extension_api::UserInstructionsProvider::load_user_instructions(self)
    }
}
...
async fn live_fork_keeps_instructions_when_source_is_unloaded_during_setup() {
    ...
    let global = antex_extension_api::Instructions {
        text: "global instructions".to_string(),
        source: None,
    };
    let thread = antex_extension_api::Instructions {
    ...
    impl antex_extension_api::McpServerContributor<Config> for InitialDataRecorder {
        ...
        ) -> antex_extension_api::ExtensionFuture<'a, Vec<antex_extension_api::McpServerContribution>>
        {
            Box::pin(async move {
                ...
                vec![
                    antex_extension_api::McpServerContribution::SelectedPluginPackage {
                        selected_root_id: plugin_id.clone(),
                        plugin_id: plugin_id.clone(),
                        plugin_display_name: plugin_id.clone(),
                        connector_ids: vec![],
                    },
                    antex_extension_api::McpServerContribution::SelectedPlugin {
