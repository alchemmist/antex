...
use antex_guardian_context::Budgeted;
use antex_guardian_context::CollectedContext;
use antex_guardian_context::ComposedContext;
use antex_guardian_context::ContextPresentation;
use antex_guardian_context::ContextProfile;
#[cfg(test)]
use antex_guardian_context::ConversationTranscriptEntry;
use antex_guardian_context::GuardianRootMessage;
use antex_guardian_context::PermissionContext;
use antex_guardian_context::PlannedAction;
use antex_guardian_context::PlannedActionKind;
use antex_guardian_context::SectionError;
use antex_guardian_context::SectionHistory;
use antex_guardian_context::SectionInput;
pub(crate) use antex_guardian_context::TranscriptCursor as GuardianTranscriptCursor;
pub(crate) use antex_guardian_context::TranscriptMode as GuardianPromptMode;
use antex_guardian_context::TranscriptSelection;
...
pub(super) fn collect_guardian_context(
    ...
    node_repl: Option<&antex_guardian_context::NodeReplContext<'_>>,
...
use antex_guardian_reviewer::guardian_output_contract_prompt;
