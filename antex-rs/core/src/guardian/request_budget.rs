...
use antex_guardian_context::REQUEST_TOKENS_BOUNDARIES;
use antex_guardian_context::REQUEST_TOKENS_METRIC;
...
pub(crate) fn check_prompt(
    ...
    config: &Config,
    model: &ModelInfo,
    metadata: &crate::responses_metadata::AntexResponsesMetadata,
) -> AntexResult<()> {
