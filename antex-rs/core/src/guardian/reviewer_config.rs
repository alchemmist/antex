...
pub fn build_guardian_review_session_config(
    ...
    reasoning_summary: antex_protocol::config_types::ReasoningSummary,
...
pub(crate) async fn resolve_review_model(
    ...
    antex_guardian_reviewer::ReviewModel,
    Arc<antex_protocol::openai_models::ModelInfo>,
) {
    ...
    let review_model = antex_guardian_reviewer::select_review_model(
        &context.model_info,
