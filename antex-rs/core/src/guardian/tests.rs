...
async fn cancelled_guardian_review_emits_terminal_abort_without_warning(
    ...
    match moment {
        ...
        ApprovalCancellation::BeforeCachedResult => {
            ...
            impl antex_extension_api::ApprovalReviewContributor for CancelWhileApproving {
                fn decide<'a>(
                    &'a self,
                    _input: &'a antex_extension_api::ApprovalDecisionInput<'_>,
                ) -> antex_extension_api::ExtensionFuture<
                    'a,
                    Option<antex_extension_api::ApprovalDecision>,
                > {
                    self.0.cancel();
...
async fn guardian_reuse_respects_effective_policy_and_personality(
    ...
    captured.personality = Some(antex_protocol::config_types::Personality::Friendly);
    ...
    different_personality.personality = Some(antex_protocol::config_types::Personality::Pragmatic);
