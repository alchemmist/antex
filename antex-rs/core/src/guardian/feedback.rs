...
pub(super) async fn record_failed_review(
    ...
    let Some(feedback) = antex_guardian_reviewer::FailedReviewFeedback::for_outcome(
        outcome,
        antex_guardian_reviewer::ReviewFeedbackSettings {
    ...
    feedback.store(antex_guardian_reviewer::ReviewFeedbackContext {
