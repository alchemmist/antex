...
use antex_network_proxy::CREDENTIAL_BROKER_ACTIVE_ENV_KEY;
use antex_network_proxy::CredentialBrokerContext;
use antex_network_proxy::NetworkProxy;
use antex_network_proxy::brokered_credential_marker_env_keys;
use antex_network_proxy::brokered_credential_value_env_keys;
use antex_otel::SessionTelemetry;
use antex_protocol::ThreadId;
use antex_protocol::config_types::ShellEnvironmentPolicy;
use antex_protocol::shell_environment::create_env_from_vars;
use antex_shell_command::shell_snapshot::CapturedSnapshot;
use antex_shell_command::shell_snapshot::PreparedSnapshot;
use antex_shell_command::shell_snapshot::SnapshotCaptureOptions;
use antex_shell_command::shell_snapshot::SnapshotCredentialEnvironment;
use antex_shell_command::shell_snapshot::SnapshotStartup;
use antex_shell_command::shell_snapshot::prepare_snapshot_credentials;
use antex_shell_command::shell_snapshot::snapshot_capture_script;
...
async fn capture_snapshot(
    ...
    snapshot_allowed_env.remove("ANTEX_NETWORK_PROXY_BROKERED_CREDENTIALS");
