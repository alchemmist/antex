...
use antex_login::default_client::ClientRedirectPolicy;
...
use antex_model_provider::ResponsesConnectionKey;
use antex_model_provider::SharedModelProvider;
use antex_model_provider::WorkspaceRoutingContext;
...
impl ModelClient {
    ...
    fn responses_session_id(&self, metadata: &AntexResponsesMetadata) -> String {
                ...
                .is_some_and(|url| {
                    url.scheme() == "https"
                        && url.host_str().is_some_and(|host| {
                            host == "api.openai.com"
                                || antex_http_client::is_allowed_chatgpt_host(host)
                        })
                });
    ...
    fn responses_headers(&self, auth: Option<&AntexAuth>, model: &str) -> ApiHeaderMap {
    ...
    fn build_api_transport(
        ...
        let redirect_policy = if api_provider
            .headers
            .contains_key(antex_model_provider::ACCOUNT_ROUTING_HEADER)
        {
