...
fn realtime_user_verification_notice_excludes_request_payload() {
    let event = EventMsg::ElicitationRequest(antex_protocol::approvals::ElicitationRequestEvent {
        turn_id: None,
        server_name: "private-server-name".to_string(),
        id: antex_protocol::mcp::RequestId::String("private-request-id".to_string()),
        request: antex_protocol::approvals::ElicitationRequest::UserVerification {
