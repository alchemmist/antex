...
pub(crate) async fn run_turn(
    ...
    if crate::guardian::is_basic_session_source(&turn_context.session_source)
        && let Err(error) = crate::guardian::finalize_guardian_input(
            ...
            &first_step_context,
            &mut input,
            antex_guardian_context::HistoryTruncation::Preserve,
        )
        .await
    {
        ...
        crate::guardian::finalize_guardian_input(
            ...
            &first_step_context,
            &mut input,
            antex_guardian_context::HistoryTruncation::Allow,
        )
        .await?;
    }
    ...
    loop {
        ...
        let sampling_request_result: AntexResult<_> = async {
            ...
            let responses_metadata = sess
                .responses_metadata(step_context.as_ref(), AntexResponsesRequestKind::Turn)
                .await;
        ...
        match event {
            ResponseEvent::Created { response_id } => {
                if let Some(response_id) = response_id {
                    turn_context
                        .extension_data
                        .insert(antex_api::ResponseId(response_id));
                }
            }
