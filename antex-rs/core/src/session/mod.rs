...
use antex_utils_output_truncation::with_serialization_allowance;
...
impl Session {
    ...
    async fn spawn_internal(args: SessionSpawnArgs) -> AntexResult<(Arc<Self>, SessionIo)> {
        ...
        let isolation = thread_extension_init
            ...
            .map(|policy| *policy)
            .unwrap_or_default();
        let exec_policy = if isolation == antex_extension_api::SessionIsolation::Isolated {
        ...
        let disabled_plugin_ids = disabled_plugin_ids.unwrap_or_else(|| {
            ...
            settings_owner
                .and_then(|thread_id| {
                    antex_history::latest_disabled_plugin_ids(
...
impl Session {
    ...
    async fn record_prepared_conversation_items(
        ...
        let policy: antex_utils_output_truncation::TruncationPolicy =
