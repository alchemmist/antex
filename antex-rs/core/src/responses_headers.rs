//! Header overrides for host-created threads on the Antex Responses endpoint.
...
///
/// Applied only to the selected model with Antex backend auth and routing. The headers
