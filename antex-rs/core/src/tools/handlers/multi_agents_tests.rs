...
fn service_tier_test_catalog() -> antex_protocol::openai_models::ModelsResponse {
    let mut catalog = antex_models_manager::bundled_models_response().expect("bundled models");
