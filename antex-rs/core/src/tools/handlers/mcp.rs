                ...
                match item.get("type").and_then(Value::as_str) {
                            ...
                            || image_capture_enabled =>
                    {
                        ...
                        Some(UserInput::Image {
                            image: antex_protocol::models::ImageReference::Inline { image_url },
                            detail,
                        })
                    }
                    _ => None,
...
mod tests {
    ...
    async fn mcp_post_tool_use_payload_uses_prefixed_tool_name_args_and_result() {
        ...
        let recorder = crate::tools::executed_tool_calls::ExecutedToolCalls::new(
            ...
            &antex_history::InitialHistory::New,
        );
        ...
        let cell_id = antex_code_mode::CellId::new("mcp-cell".to_string());
        ...
        assert_eq!(
            ...
            json!([{
                "name": antex_tools::code_mode_name_for_tool_name(&invocation.tool_name),
