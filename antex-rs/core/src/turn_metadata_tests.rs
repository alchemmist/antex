...
async fn execution_metadata_applies_captured_settings_to_responses_metadata() {
    ...
    config.approvals_reviewer = antex_protocol::config_types::ApprovalsReviewer::AutoReview;
    config.permissions.approval_policy =
        crate::config::Constrained::allow_any(antex_protocol::protocol::AskForApproval::OnRequest);
