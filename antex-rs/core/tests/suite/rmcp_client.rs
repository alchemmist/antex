...
use antex_protocol::turn_input::TurnInput;
...
async fn interrupt_during_mcp_startup_preserves_user_input_in_history(
    ...
    fixture.antex.start_or_steer_turn(input).await?;
    let turn_id = core_test_support::wait_for_event_match(&fixture.antex, |event| match event {
