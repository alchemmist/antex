...
use antex_core::windows_sandbox::WindowsSandboxSetupMode;
use antex_core::windows_sandbox::WindowsSandboxSetupRequest;
use antex_core::windows_sandbox::run_windows_sandbox_setup;
...
async fn windows_elevated_setup_rejects_default_root_deny() -> anyhow::Result<()> {
    let codex_home = antex_home_for_windows_sandbox_test("windows-elevated-root-deny-codex-home")?;
