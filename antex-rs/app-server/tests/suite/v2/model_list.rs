...
async fn api_key_model_discovery_startup_enablement_respects_user_config(
    ...
    let mut remote_model = antex_models_manager::bundled_models_response()?
        .models
        .remove(0);
    remote_model.slug = "rollout-model".into();
    remote_model.visibility = antex_protocol::openai_models::ModelVisibility::List;
    ...
    let mut mcp = TestAppServer::builder()
        ...
        .build_initialized()
        .await?;
    let mut bundled = antex_models_manager::bundled_models_response()?.models;
