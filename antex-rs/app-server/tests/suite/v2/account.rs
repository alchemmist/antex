...
fn expected_workspace_routing(
    account_id: &str,
) -> Option<antex_app_server_protocol::WorkspaceRouting> {
    Some(antex_app_server_protocol::WorkspaceRouting {
        chatgpt_account_id: account_id.to_string(),
        backend_origin: "https://chatgpt.com".to_string(),
        account_routing_override: antex_app_server_protocol::AccountRoutingOverride::NoConstraint,
    })
}
