...
pub async fn write_models_cache_with_models(
    ...
    let config = antex_core::config::ConfigBuilder::default()
        .loader_overrides(antex_config::LoaderOverrides::without_managed_config_for_tests())
        .codex_home(codex_home.to_path_buf())
        .build()
        .await?;
    let auth = antex_login::AntexAuth::from_auth_storage(
        codex_home,
    ...
    .await?;
    let cache = antex_model_provider::test_support::models_cache_entry(
