...
use super::*;
use antex_app_server_protocol::MemoryStatusParams;
use antex_app_server_protocol::MemoryStatusResponse;
...
impl ThreadRequestProcessor {
    pub(crate) async fn memory_status(
        ...
        let ready = count >= minimum
            && summary
                .as_deref()
                .is_some_and(antex_memories_write::workspace::is_valid_v2_summary);
        Ok(Some(
