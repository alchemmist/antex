...
use super::*;
use antex_app_server_protocol::AccountRoutingOverride;
use antex_app_server_protocol::WorkspaceRouting;
use antex_backend_client::AccountEntry;
use url::Url;
                ...
                .await
            {
                ...
                Err(_)
                    if !self
                        ...
                        .auth_cached()
                        .as_ref()
                        .is_some_and(AntexAuth::is_chatgpt_auth) =>
                {
