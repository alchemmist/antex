...
pub(super) struct ThreadEventSnapshot {
    ...
    pub(super) active_reasoning_item: Option<antex_app_server_protocol::ItemStartedNotification>,
    ...
    fn push_notification_inner(&mut self, notification: Cow<'_, ServerNotification>) {
        ...
        match notification.as_ref() {
            ...
            ServerNotification::ItemStarted(
                started @ antex_app_server_protocol::ItemStartedNotification {
                ...
                }) =>
            {
                self.active_reasoning_item =
                    Some(antex_app_server_protocol::ItemStartedNotification {
