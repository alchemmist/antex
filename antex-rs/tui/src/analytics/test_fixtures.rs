...
pub(super) fn chats() -> super::chats::Chats {
    use antex_backend_client::ThreadUsage;
    use antex_backend_client::ThreadUsageBreakdownGroup;
    super::chats::Chats {
        rows: [
...
pub(super) fn view(kind: super::models::AccountKind) -> super::AnalyticsView {
    ...
    view.account = super::data::Load::Ready(match kind {
        super::models::AccountKind::Consumer => antex_protocol::account::PlanType::Plus,
        super::models::AccountKind::Business => antex_protocol::account::PlanType::Team,
        super::models::AccountKind::Enterprise => {
            antex_protocol::account::PlanType::EnterpriseCbpUsageBased
        }
        super::models::AccountKind::Unknown => antex_protocol::account::PlanType::Unknown,
    });
