...
pub(crate) struct AnalyticsView {
    ...
    chat_metric: usize,
    profile: Load<antex_backend_client::AccountProfile>,
    plan: plan::State,
    show_zero_credit_groups: bool,
    account: Load<antex_protocol::account::PlanType>,
...
impl AnalyticsView {
    ...
    pub(crate) fn open(
        ...
        models: Vec<antex_protocol::openai_models::ModelPreset>,
        ...
        self.plan.enabled = config
            .features
            .enabled(antex_features::Feature::AnalyticsPlanHistory);
                    ...
                    live.session().await.map(|session| {
                        Some(
                            session
                                ...
                                .account()
                                .plan_type
                                .unwrap_or(antex_protocol::account::PlanType::Unknown),
                        )
                    })
                },
                frame.clone(),
