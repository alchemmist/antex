...
use antex_app_server_protocol::WindowsSandboxImplementation;
...
pub(crate) fn host_from_environments(
    environments: Option<&[antex_app_server_protocol::ThreadEnvironment]>,
    ...
    let local = environments
        .iter()
        .any(|environment| environment.environment_id == antex_exec_server::LOCAL_ENVIRONMENT_ID);
