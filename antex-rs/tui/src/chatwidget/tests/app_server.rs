...
async fn startup_config_warning_is_not_repeated_by_thread() {
    let (mut chat, mut rx, _op_rx) = make_chatwidget_manual(/*model_override*/ None).await;
    let message = "Antex is ignoring 1 unrecognized configuration setting. Check for typos or deprecated settings.";
    ...
    ⚠ Antex is ignoring 1 unrecognized configuration setting. Check for typos or
      deprecated settings.
    ");
}
