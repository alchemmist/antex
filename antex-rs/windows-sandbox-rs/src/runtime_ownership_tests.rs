...
fn record() -> InstallationRecord {
    InstallationRecord {
        ...
        codex_home: PathBuf::from(r"C:\Users\owner\.antex"),
        session_id: 1,
        desktop_installation: Some(DesktopInstallation {
            created_antex_home: true,
...
fn production_record_without_optional_core_or_desktop_fields_still_loads() {
    ...
    let json = r#"{"user_sid":"S-1-5-21-1-2-3-1000","codex_home":"C:\\Users\\owner\\.antex","session_id":1}"#;
    assert_eq!(
        serde_json::from_str::<InstallationRecord>(json).unwrap(),
        expected
    );
