...
impl FilesystemDenyReadPattern {
    ...
    pub fn from_input(input: &str) -> Result<Self, String> {
        antex_utils_path_uri::PathUri::validate_config_path_text(
            input,
        ...
        if crate::path_context::convention() == antex_utils_path_uri::PathConvention::Windows
...
fn validate_literal_denial_path(path: &str) -> Result<(), String> {
    ...
    antex_utils_path_uri::LegacyAppPathString::from_string(path)
    ...
    match separator_index {
        ...
        Some(index)
            if crate::path_context::convention()
                == antex_utils_path_uri::PathConvention::Windows
                && index == 2
